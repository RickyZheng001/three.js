...
{
    var docElement = document.getElementById("daoJuSearch");
    //var table = document.getElementById("daoJuSearch_main_right_top_bottom");
    if(docElement == null || docElement == undefined)
    {
        return;
    }

    var strVisible = docElement.style.visibility;// = table.style.visibility;
...
function OnClickNew()
{
    var docElement = document.getElementById("jiShuVideo");
...
function OnClickLuiYan()
{


    var docElement = document.getElementById("missage");
    if(docElement == null || docElement == undefined)
    {
        return;
    }
...
function OnCheck()
{
    ...
    var docElement = document.getElementById("check");
    if(docElement == null || docElement == undefined)
    {
        return;
    }
